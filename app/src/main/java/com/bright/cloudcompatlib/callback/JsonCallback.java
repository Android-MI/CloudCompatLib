package com.bright.cloudcompatlib.callback;

import com.bright.cloudcompatlib.model.LzyResponse;
import com.bright.cloudcompatlib.model.SimpleResponse;
import com.bright.cloudcompatlib.utils.Convert;
...
public abstract class JsonCallback<T> extends AbsCallback<T> {
    ...
    public void onBefore(BaseRequest request) {
        ...
        request.headers("header1", "HeaderValue1")//
                ...
                .params("token", "xmixmi3215sdf13ad1f65asd4f3ads1f");
    }
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        // 详细原理说明：https://github.com/jeasonlzy/okhttp-OkGo/blob/master/README_JSONCALLBACK.md
